...
## HW1 - Renewable and Energy Efficiency Incentives and Policies -- Database, Document and Information Summarizer
...
## HW2 - Residential Energy Consumption Prediction from Available Features
...
## HW3 - Image Classification of Buildings with/without Window AC Units
...
## Capstone - Building Energy Star Score Prediction Augmented with Satellite Imagery (Geospatial and tabular data)
